...
function check()
{
    ...
    if(answer == word)
    {
        ...
        if(question_turn == "player1")
        {
            ...
            document.getElementById("player_question").innerHTML ="Quetsion Turn - " +  player2_name;
        }
        else
        {
            question_turn = "player1"
            document.getElementById("player_question").innerHTML ="Quetsion Turn - " +  player1_name;
